...
|AppVeyor|Travis CI|
|:-:|:-:|
|[![Build status](https://ci.appveyor.com/api/projects/status/github/apache/cordova-plugin-eletropay-printer?branch=master)](https://ci.appveyor.com/project/ApacheSoftwareFoundation/cordova-plugin-eletropay-printer)|[![Build Status](https://travis-ci.org/apache/cordova-plugin-eletropay-printer.svg?branch=master)](https://travis-ci.org/apache/cordova-plugin-eletropay-printer)|

# cordova-plugin-eletropay-printer
...
## Installation
    ...
    cordova plugin add cordova-plugin-eletropay-printer
