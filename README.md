...
`ionic cordova plugin add cordova-plugin-eletropay-printer`
...
```
{
    "name": "cordova-plugin-eletropay-printer",
    "version": "1.0.0",
    "description": "Android Toast Plugin",
    "cordova": {
        "id": "cordova-plugin-eletropay-printer",
        "platforms": [
            "android"
        ]
    },
...
`git clone https://github.com/Hitman666/cordova-plugin-eletropay-printer.git`

CD into the cloned project

`cd cordova-plugin-eletropay-printer`
